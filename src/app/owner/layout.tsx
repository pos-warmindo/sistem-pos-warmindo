...
export default function OwnerLayout({
  ...
  const navItems: NavigationItem[] = [
    ...
    {
      name: "Stok",
      href: "/owner/dashboard#stok", // link placeholder or actual path in future
      icon: Package,
    },
    {
      name: "Laporan",
      href: "/owner/dashboard#laporan", // link placeholder or actual path in future
      icon: FileText,
    },
  ];
  ...
  return (
    <div className="min-h-screen flex bg-slate-50/50">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 border-t border-slate-200 bg-white/95 backdrop-blur-md flex justify-around py-2 px-1 z-30 shadow-lg pb-safe">
        ...
        >
          <LogOut className="h-5.5 w-5.5 mb-1" />
          <span className="text-[10px] font-semibold tracking-wider">
            Keluar
          </span>
        </button>
